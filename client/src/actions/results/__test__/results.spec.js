...
import { words, answers, currentResult, languageTo, languageFrom, dictionaryName, answerData } from '../../../../test/testData';
import { FETCH_SAVE_RESULTS, CALCULATE_CURRENT_RESULTS_ERROR, FETCH_SAVE_RESULTS_ERROR, CALCULATE_CURRENT_RESULTS_SUCCESS, FETCH_SAVE_RESULTS_SUCCESS } from '../../../constants/results';
import { initialState } from '../../../reducers/home';
import { STATUS_ERROR, STATUS_OK } from '../../../constants/app';
import { calculateCurrentResults, saveResult } from '../';
...
describe('calculating and saving current results action creators', () => {
  ...
  describe('test saveResult action creator', async () => {
    ...
    it('dispatches the correct actions on successful fetch request',
      // async () => {
      // const successResponse = { response: { status: STATUS_OK, message: 'Your result successfully saved' }, data: null };
      // nock(config.apiPath, {
      //   reqheaders: {
